...
const translations = {
  es: {
    ...
    penaltiesDesc: 'Cuatripod, trampa, salir del green, paloma — pagas a cada jugador',
    cuatripodLabel: 'Cuatripod (4+ putts)',
  ...
  en: {
    ...
    penaltiesDesc: 'Four-putt, bunker stuck, off the green, whiff — pay each player',
    cuatripodLabel: 'Four-putt (4+ putts)',
