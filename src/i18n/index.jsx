...
const translations = {
  es: {
    ...
    bunker: '🏖️ Bunker',
    holeOut: '🎯 Hole-out',
    stuckInBunkerChip: '🪤 Atascado',
    leftGreenChip: '🚪 Salió del green',
    whiffChip: '🕊️ Paloma',
    score: 'Score',
    putts: 'Putts',
    drive: '💨 Drive',
    ...
    deleteRoundConfirmTitle: '¿Eliminar ronda?',
    deleteRoundConfirmBody: 'Esta ronda sin completar se borrará para todos los jugadores. No se puede deshacer.',
    deleteRoundConfirmBtn: 'Eliminar',
    ...
    noPenaltiesYet: 'Sin penalidades aún',
    ...
    penaltiesLabel: 'Penalidades',
    penaltiesDesc: '4-putts, trampa, salir del green, paloma — pagas a cada jugador',
    cuatripodLabel: '4-putts',
    trampaLabel: 'Trampa (3 golpes sin salir)',
    saleVerdeLabel: 'Salir del green',
    palomaLabel: 'Paloma (whiff)',
  ...
  en: {
    ...
    bunker: '🏖️ Bunker',
    holeOut: '🎯 Hole-out',
    stuckInBunkerChip: '🪤 Stuck in bunker',
    leftGreenChip: '🚪 Left the green',
    whiffChip: '🕊️ Whiff',
    score: 'Score',
    putts: 'Putts',
    drive: '💨 Drive',
    ...
    deleteRoundConfirmTitle: 'Delete round?',
    deleteRoundConfirmBody: 'This unfinished round will be deleted for all players. This cannot be undone.',
    deleteRoundConfirmBtn: 'Delete',
    ...
    noPenaltiesYet: 'No penalties yet',
    ...
    penaltiesDesc: '4-putts, bunker stuck, off the green, whiff — pay each player',
    cuatripodLabel: '4-putts',
    trampaLabel: 'Bunker stuck (3 shots, no escape)',
    saleVerdeLabel: 'Off the green',
    palomaLabel: 'Whiff',
